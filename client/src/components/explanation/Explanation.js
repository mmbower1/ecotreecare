...
const Explanation = () => {
  return (
    <div className="explanation">
      <h1>Welcome to American Arbor Tree Care Professionals</h1>
      <p>American Arbor Tree Care Professionals provides excellent tree care services and comprehensive plans for landscape management. Tree care is our passion and we provide every customer with a hands on maintenance plan that gives you control over how your landscape looks. All of our rates are affordable and come with the guarantee that we will cut no corners, no matter how small or large the project is. No matter what the job, we can help you finish it.
        <br /><br />
      ...
      <br />
      <ul>
        <li>Conservative, prevision pruning</li>
        <li>Selection and placement consulting</li>
        <li>Removal and Replacement</li>
        <li>Construction impact mitigation, tree protection</li>
        <li>Cabling</li>
        <li>Inventories and arborist reports </li>
        ...
        <li>Fertilization, mycorrhizal applications, soil work</li>
      </ul>
