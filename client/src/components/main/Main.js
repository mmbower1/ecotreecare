      ...
      <div className="gallery">
        <figure className="gallery-item">
          ...
          <div className="overview-reading-1">
            <p>Since 1982, American Arbor has worked proudly in the tree care industry with keen interest in both the quality and the... 
        ...
        <figure className="gallery-item">
          ...
          <div className="overview-reading-1">
            <p>Many properties, including HOA’s, golf courses and commercial complexes, can benefit greatly utilizing a management plan... 
              <Link to='/services' style={{'color': '#fff'}}>(learn more)</Link>
            </p>
          </div>
        </figure>
        <figure className="gallery-item">
          ...
          <div className="overview-reading-1">
            <p>California’s drought has provided plant health care providers with a long-sought opportunity to address a very real problem... 
              <Link to='/services' style={{'color': '#fff'}}>(learn more)</Link>
            </p>
          </div>
        </figure>
